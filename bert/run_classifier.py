...
flags.DEFINE_bool("do_distill", False, "Whether to distill the model.")  # 新增两个新的输入参数 temperature 和 do_distill
# temperature：蒸馏的温度值 do_distill：是否要进行蒸馏
...
def main(_):
    ...
    if FLAGS.do_predict:
        ...
        time_end1 = time.time()
        print("time1 diff: {}".format(time_end1 - time_start))
